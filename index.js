...
const filterArr2014 = fifaData.filter((element) => {
    return element.Year === 2014 && element.Stage === 'Final';
});
console.log(filterArr2014);
//(a) Home Team name for 2014 world cup final
console.log(filterArr2014[0]['Home Team Name']);
//(b) Away Team name for 2014 world cup final
console.log(filterArr2014[0]['Away Team Name']);
//(c) Home Team goals for 2014 world cup final
console.log(filterArr2014[0]['Home Team Goals']);
//(d) Away Team goals for 2014 world cup final
console.log(filterArr2014[0]['Away Team Name']);
//(e) Winner of 2014 world cup final */
console.log(filterArr2014[0]['Win conditions'] );
...
function getFinals(data) {
    const finalStage = data.filter((element) => {
